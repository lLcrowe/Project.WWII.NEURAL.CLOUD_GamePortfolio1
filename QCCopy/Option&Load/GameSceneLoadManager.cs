    ...
    public class GameSceneLoadManager : MonoBehaviourSingleton<GameSceneLoadManager>
    {
        ...
        private IEnumerator LoadScene(string nextScene, LoadSceneMode loadSceneMode)
        {
            ...
            while (!op.isDone)
            {
                ...
                targetProgressBarImage.SetCurValue(value * 100f);
                ...
                //if (Input.anyKeyDown)//안먹힘//작동안됨
                Event e = Event.current;//이것도 안되는데? 왜그럴까
            ...
            //yield return new WaitForSeconds(1f);//이걸로 해야 보기 편할듯
            isLoading = false;            
