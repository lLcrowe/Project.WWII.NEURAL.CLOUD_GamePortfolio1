...
namespace lLCroweTool
{
    ...
    public static class lLcroweUtil 
    {
        ...
        public static Vector3Int[] GetNearDistancePos(Vector3Int tilePos, int distance, Custom3DHexTileMap custom3DHexTileMap)
        {
            ...
            return nearRangePosList.ToArray();
        }
        ...
        public static Vector3Int[] GetNearRangePos(Vector3Int tilePos, int range, Custom3DHexTileMap custom3DHexTileMap)
        {
        ...
        public static System.Collections.IEnumerator WaitAndDestroy(Transform targetObject, float timer)
        {
        ...
        /// <param name="component">컴포넌트</param>
        /// <param name="value">활성화/비활성화</param>
        public static void SetEnable(this MonoBehaviour component, bool value)
        {
        ...
        public static T GetResourcesForObject<T>(string fileName, CATPathType pathType) where T : Object
        {
            ...
            //Object를 사용해서 프리팹을 찾을경우 게임오브젝트를 찾음
            //component로 찾아야지 컴포넌트로 찾음
